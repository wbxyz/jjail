...
2. **Your sandbox is the `agent` bookmark.** All your work must be rooted from the commits in the `agent::` subtree. `jjail` enforces this boundary. If you get a "Sandbox violation!" error, you are operating outside your allowed scope.
...
### Committing Changes
```bash
jjail describe @ "feat: my new feature"
```
